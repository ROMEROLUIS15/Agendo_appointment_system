...
const PAGE_TITLES: Array<{
  ...
  {
    match: (p) => p.includes("/appointments/new"),
    title: "Nueva Cita",
    subtitle: "Agenda",
  },
  {
    match: (p) => /\/appointments\/.+\/edit/.test(p),
    title: "Editar Cita",
    subtitle: "Agenda",
  },
  {
    match: (p) => p.includes("/appointments"),
    title: "Agenda",
    subtitle: "Gestión de citas",
  },
  {
    match: (p) => p.includes("/clients/new"),
    title: "Nuevo Cliente",
    subtitle: "Clientes",
  },
  {
    match: (p) => /\/clients\/.+\/edit/.test(p),
    title: "Editar Cliente",
    subtitle: "Clientes",
  },
  {
    match: (p) => /\/clients\/.+/.test(p),
    title: "Perfil del Cliente",
    subtitle: "Clientes",
  },
  {
    match: (p) => p.includes("/clients"),
    title: "Clientes",
    subtitle: "Base de datos",
  },
  {
    match: (p) => p.includes("/services"),
    title: "Servicios",
    subtitle: "Catálogo",
  },
  {
